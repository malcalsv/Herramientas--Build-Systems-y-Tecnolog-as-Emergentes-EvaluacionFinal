...
class Carrito extends React.Component{
          ...
          <div className="container">
            ...
            <div className="animated fadeIn slow">
              <div className="box carrito">
                <div className="row col s12 brown darken-4 animated fadeInDown fast">
          ...
          <div className="container">
            ...
            <div className="animated fadeIn slow">
              <div className="box white col s12 center-align" style={{padding: '5%'}}>
                <h5  style={{height : '70vh', display : 'table-cell', verticalAlign : 'middle'}} >Debes agregar productos al carrito de compras. Vuelve a <Link to="/tienda">El Magila</Link></h5>
              </div>
            </div>
          </div>
        </div>
  ...
  pagarCarrito(){
    ...
    request
    .get('https://tienda-96fcc.firebaseio.com/productos/.json')                //Realizar una consulta a la base de datos
    .then((res) => {
...
actualizarDB(itemCatalogo, cantidad){
  request.put(`https://tienda-96fcc.firebaseio.com/productos/${itemCatalogo.id}.json`)  //Realizar consulta a base de datos
