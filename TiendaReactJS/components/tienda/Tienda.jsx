      ...
      <div className="container">
        ...
        <div className="left lista-productos box">
          <div className="col s12 white darken-1 animated fadeInDown fast">
            <h4 className="col m6 s12 orange-text shadow left ">Cátalogo de productos</h4>
            <h4 className="right col m6 s12 input-field">
            <i className="material-icons prefix">search</i>
            <input onChange={this.filtrarCatalogo.bind(this)} type="text" id="descripcion" placeholder="fresa"  type="text" className="orange-text no-margin-bottom"/>
            <label htmlFor="descripcion">¿Qué estás buscando?</label>
            </h4>
          </div>
        {
