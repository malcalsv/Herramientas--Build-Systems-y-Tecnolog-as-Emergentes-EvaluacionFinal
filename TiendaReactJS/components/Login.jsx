...
//-----------------------------------------------------------------------------
  checkLogin(event) {
    ...
    console.log(password);
      if(email === "malcals@gmail.com") {
        if (password === "malcals123"){
          ...
          <div className="col s6 form-container animated fadeIn slow">
            <form onSubmit={this.checkLogin}>
              ...
              <div className="col s12 input-field">
                <input type="email" ref="email" id="email" value={this.state.email} onChange={this.handleChange} placeholder="malcals@gmail.com" className="validate white-text" required aria-required="true" />
                <label htmlFor="email" data-error="Email Incorrecto" data-success="Email Correcto">Correo Electrónico</label>
              </div>
              <div className="col s12 input-field">
                <input type="password" ref="password" id="password" value={this.state.password} onChange={this.handleChange} placeholder="malcals123" className="validate  white-text" required aria-required="true" />
                <label> </label>
