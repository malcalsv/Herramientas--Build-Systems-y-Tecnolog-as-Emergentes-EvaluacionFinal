  ...
  mostrarProductos(){
    if(!this.tiendaService.productosCatalogo){ //Verificar si se ha cargado previamente la información del catálogo
      this.tiendaService.getProductos().subscribe(data=>{
          //this.listaProductos = this.tiendaService.catalogo //base de datos
          
          //console.log(this.listaProductos);
          
          this.prods = this.tiendaService.productosCatalogo
...
//================Agregar Productos=============================================
  ...
  //================Filtrar Productos============================================
    filtrarCatalogo(filtro:string){
      this.prods = this.tiendaService.filtrarProducto(filtro); //Actualizar el catálogo de productos mostrados de acuerdo al resultado obtenido en el filtro de productos
      console.log(filtro);
    }
